...
# =============================================================================
echo -e "${YELLOW}Проверяем системные зависимости...${NC}"
...
# =============================================================================
echo -e "${YELLOW}[1/6] Проверяем последнюю версию на GitHub...${NC}"
...
# =============================================================================
echo ""
echo -e "${YELLOW}[2/6] Настройка параметров прокси${NC}"
echo ""
...
# =============================================================================
echo ""
echo -e "${YELLOW}[3/6] Клонируем репозиторий v${LATEST_VERSION}...${NC}"
...
echo ""
echo -e "${YELLOW}[4/6] Создаём виртуальное окружение и устанавливаем зависимости...${NC}"
...
# =============================================================================
echo ""
echo -e "${YELLOW}[5/6] Создаём systemd-сервис...${NC}"
...
# =============================================================================
echo ""
echo -e "${YELLOW}[6/6] Проверяем статус сервиса...${NC}"
